...
# Import data
Gene_Mat=fread("/home/datawork-lmee-intranet-nos/ACE/07-STATS-CAGs-OF-INTEREST/GM_AGN_T60MAXGQ_transposed_CAG_37_ATT.tsv", data.table=F)
names(Gene_Mat)[1]="Sample_ID"
Annotation=fread("/home/datawork-lmee-intranet-nos/ACE/07-STATS-CAGs-OF-INTEREST/Annotation_Table_AGN_CDH_Tax_KEGG_EGG_CAG_37ATT.tsv", data.table=F,fill=T,sep="\t",header=T)
...
bptop=ggplot() + geom_boxplot(aes(x = reorder(Var2,value,FUN=median), y = value), data = boxplot[which(boxplot$Var2 %in% boxplotTop),]) +
  ...
  labs(x = "", y = "Rank of importance in random forest regressions")
bptop
ggsave("/home/datawork-lmee-intranet-nos/ACE/07-STATS-CAGs-OF-INTEREST/02-FIGURES/Importance_Boxplot_CAG_37ATT_Top10.pdf",width=18,height=25,unit="cm")
...
ggsave("/home/datawork-lmee-intranet-nos/ACE/07-STATS-CAGs-OF-INTEREST/02-FIGURES/AbundEnviPlot_CAG_37ATT.png",width=23,height=21,unit="cm")
...
png(filename="/home/datawork-lmee-intranet-nos/ACE/07-STATS-CAGs-OF-INTEREST/02-FIGURES/CAG_37ATT_AGNOSTOSTreeMap.png",width=20, height=20,units="cm",res=1200)
...
MAG_Tax=fread("/home/datawork-lmee-intranet-nos/ACE/07-STATS-CAGs-OF-INTEREST/Taxo_MAGs_CAG_37ATT.tsv", data.table=F, header=F, fill=T, stringsAsFactors=T)
names(MAG_Tax)=c("ContigID","MAG_ID","REP_MAG_ID","Domain","Phylum","Class","Order","Family","Genus","Species")
list_contigs=fread("/home/datawork-lmee-intranet-nos/ACE/07-STATS-CAGs-OF-INTEREST/list_contigs_CAG_37ATT.tsv",data.table=F, header=F, fill=T, stringsAsFactors=T)
...
ggsave("/home/datawork-lmee-intranet-nos/ACE/07-STATS-CAGs-OF-INTEREST/02-FIGURES/TaxoBarTot_CAG_37ATT.pdf",width=18,height=30,unit="cm")
...
ggsave("/home/datawork-lmee-intranet-nos/ACE/07-STATS-CAGs-OF-INTEREST/02-FIGURES/TaxoBarFam_CAG_37ATT.pdf",width=18,height=30,unit="cm")
...
ggplot() + geom_col(aes(x=1, y=Freq, col=Var1, fill=Var1)) +
 ...
 theme(text = element_text(size=20))
ggsave("/home/datawork-lmee-intranet-nos/ACE/07-STATS-CAGs-OF-INTEREST/02-FIGURES/TaxoBarGen_CAG_37ATT.pdf",width=18,height=30,unit="cm")
...
CAG_AGCList=fread("/home/datawork-lmee-intranet-nos/ACE/07-STATS-CAGs-OF-INTEREST/CAG_37_ATTRsquared15.txt", data.table=F,fill=T,sep="\t",header=F)
...
fwrite(Enrichment_EggNOGCat, "/home/datawork-lmee-intranet-nos/ACE/07-STATS-CAGs-OF-INTEREST/EnrichmentCAG_37ATT_AGCLevel.tsv",quote=FALSE,sep="\t")
...
ggplot() + geom_col(aes(y=Annotation,x=Odds_Ratio)) +
 theme_bw() +
 theme(text = element_text(size=20))
ggsave("/home/datawork-lmee-intranet-nos/ACE/07-STATS-CAGs-OF-INTEREST/02-FIGURES/EnrichmentCOGCat_MinOcc1000_AGCLevel_CAG_37ATT_Top10Only.pdf",width=18,height=30,unit="cm")

# b- EggNOG Desc

Enrichment_EggNOGDesc = test_for_enrichment(Annotation_CAG, Annotation, Annotation_Type=best_OG_desc,minimum.occ=1000)

fwrite(Enrichment_EggNOGDesc, "/home/datawork-lmee-intranet-nos/ACE/07-STATS-CAGs-OF-INTEREST/EnrichmentCAG_37ATT_AGCLevel_EggNogDesc.tsv",quote=FALSE,sep="\t")
...
ggsave("/home/datawork-lmee-intranet-nos/ACE/07-STATS-CAGs-OF-INTEREST/02-FIGURES/EnrichmentCOGDesc_MinOcc1000_AGCLevel_CAG_37ATT_Top10Only.pdf",width=18,height=30,unit="cm")
}
...
fwrite(Enrichment_KEGG, "/home/datawork-lmee-intranet-nos/ACE/07-STATS-CAGs-OF-INTEREST/EnrichmentCAG_37ATT_AGCLevel_KeggKO.tsv",quote=FALSE,sep="\t")
...
ggsave("/home/datawork-lmee-intranet-nos/ACE/07-STATS-CAGs-OF-INTEREST/02-FIGURES/EnrichmentKEGG_MinOcc100_AGCLevel_CAG_37ATT_Top10Only.pdf",width=18,height=30,unit="cm")
