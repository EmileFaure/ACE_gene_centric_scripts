...
NMDSData = readRDS("/home/datawork-lmee-intranet-nos/ACE/06-STATS-GENE-MAT/NMDS_AGC_NZVuniquecut20_FreeLiving.rds")
...
plot.NMDS.wm
ggsave("/home/datawork-lmee-intranet-nos/ACE/06-STATS-GENE-MAT/Figures/plot_NMDS_Freeliving_wm.pdf")
...
plot.NMDS.lh <- ggplot(data = df.NMDS,
  ...
  guides(shape = guide_legend(ncol=2))
plot.NMDS.lh
ggsave("/home/datawork-lmee-intranet-nos/ACE/06-STATS-GENE-MAT/Figures/plot_NMDS_Freeliving_lh.pdf")
...
plot.NMDS.temp <- ggplot(data = df.NMDS,
  ...
  guides(shape = guide_legend(ncol=2))
plot.NMDS.temp
ggsave("/home/datawork-lmee-intranet-nos/ACE/06-STATS-GENE-MAT/Figures/plot_NMDS_Freeliving_temp.pdf")
...
plot.NMDS.d13c <- ggplot(data = df.NMDS,
  ...
  guides(shape = guide_legend(ncol=2))
plot.NMDS.d13c
ggsave("/home/datawork-lmee-intranet-nos/ACE/06-STATS-GENE-MAT/Figures/plot_NMDS_FreeLiving_d13C.pdf")
...
plot.NMDS.BSi <- ggplot(data = df.NMDS,
  ...
  guides(shape = guide_legend(ncol=2))
plot.NMDS.BSi
ggsave("/home/datawork-lmee-intranet-nos/ACE/06-STATS-GENE-MAT/Figures/plot_NMDS_FreeLiving_BSi.pdf")
