...
df=pd.read_table('/home/datawork-lmee-intranet-nos/ACE/06-STATS-GENE-MAT/GM_AGN_T60MAXGQ_transposed_NZVuniquecut20_ATT_RSquared15.tsv',index_col=[0]).transpose()
...
f = open("/home/datawork-lmee-intranet-nos/ACE/06-STATS-GENE-MAT/CAGs_T60MAX_ATT_RSquared15.txt","w")
