...
Gene_mat=readRDS("/home/datawork-lmee-intranet-nos/ACE/06-STATS-GENE-MAT/GM_AGN_TMAX60GQ_transposed_NZVuniquecut20_Attached_211.rds")
...
write.table(new.row, "/home/datawork-lmee-intranet-nos/ACE/06-STATS-GENE-MAT/random_forests_AGC_TMAX60GQ_NZVuniquecut20_Attached_211.txt", quote=FALSE,sep="\t")
