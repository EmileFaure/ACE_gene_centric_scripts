...
RF_out=fread("/home/datawork-lmee-intranet-nos/ACE/06-STATS-GENE-MAT/RF_AGC_NZVuniquecut20_T60MAX_ATT_All.txt",data.table=F)
CAGs=fread("/home/datawork-lmee-intranet-nos/ACE/06-STATS-GENE-MAT/CAGs_T60MAX_ATT_RSquared15.txt",data.table=F,header=F)
...
Gene_Mat=Gene_Mat[-1,]
fwrite(Gene_Mat,"/home/datawork-lmee-intranet-nos/ACE/06-STATS-GENE-MAT/GM_CAGs_T60MAXGQ_transposed_NZVuniquecut20_ATT_RSquared15.tsv",quote=FALSE,sep="\t",row.names=T)
rm(Gene_Mat)
...
fwrite(RF_CAGs_agg,"/home/datawork-lmee-intranet-nos/ACE/06-STATS-GENE-MAT/CAGs_T60MAX_ATT_RSquared15_AggregateWithRF.txt",quote=FALSE,sep="\t")
